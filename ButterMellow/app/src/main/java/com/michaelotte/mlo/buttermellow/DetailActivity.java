...
public class DetailActivity extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            // explicit intent to launch SettingsActivity
    ...
    private void openPreferredLocationInMap() {
        ...
        String location = sharedPrefs.getString("latLon", "Current Location");
        ...
        // Start activity with this intent only if the intent resolves properly
    ...
    public static class DetailFragment extends Fragment implements LoaderCallbacks<Cursor> {
        ...
        private static final String FORECAST_SHARE_HASHTAG = " #Buttermellow App";
        // Take forecast string and make it into a member variable
        ...
        private Intent createShareForecastIntent() {
            ...
            // prevents the activity that we are sharing to from being placed onto the activity stack
            // prevents from the app that is actually handling the intent to be foregrounded
            // this flag returns us to Buttermellow app
